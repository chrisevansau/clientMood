...
use Acme\ClientMoodBundle\Entity\Client;
use Acme\ClientMoodBundle\Form\ClientType;
...
class ClientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeClientMoodBundle:Client')->findAll();

        return $this->render('AcmeClientMoodBundle:Client:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeClientMoodBundle:Client')->find($id);
        ...
        return $this->render('AcmeClientMoodBundle:Client:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AcmeClientMoodBundle:Client:edit.html.twig', array(
            'entity'      => $entity,
